...
export const BUILD = '2026-07-14-black-hole-v01';
...
export const DISTRICTS = [
  { id: 0, name: 'Двор', minMass: 0, goal: 'Сначала ешь монеты и коробки' },
  { id: 1, name: 'Парковка', minMass: 45, goal: 'Теперь можно охотиться на скутеры и машины' },
  { id: 2, name: 'Проспект', minMass: 120, goal: 'Финальная цель — добраться до автобуса' },
] as const;
